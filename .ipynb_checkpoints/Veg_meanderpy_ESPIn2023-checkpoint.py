...
#             north_cutoff_list = np.array([])
#             south_cutoff_list = np.array([])
#             print('Cutoffs', chb.cutoffs)
...
#             north_cutoff_list = np.append(north_cutoff_list, north_cutoff)
#             south_cutoff_list = np.append(south_cutoff_list, south_cutoff)
